...
export async function fetchWithRateLimit(urls, limit = 5) {
  const results = [];
...
export async function getFriendDetails(friendIds) {
...
export async function getCharacterFriends(characterId) {
  const baseUrl = `https://census.daybreakgames.com/s:${process.env.SERVICE_ID}/get/ps2:v2`;
